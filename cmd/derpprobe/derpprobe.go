...
var (
	...
	meshPort           = flag.Int("mesh-addr", 0, "optional, Specify a separate http/https listen address for mesh connections, if unset, mesh will use the port listed in the derpmap")
